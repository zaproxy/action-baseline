...
**Optional** By default ZAP Docker container will create a new GitHub issue for every new scan.
Set it to `false` to only produce the ZAP reports but create no issues.
